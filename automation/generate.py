...
HUGGINGFACE_MODELS_COLUMN_NAME = "huggingface_models"
...
HUGGINGFACE_MODELS_BADGE_PATTERN = "[![Hugging Face Models](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Models-blue)]({})"
...
def format_entry(entry: Series) -> str:
    ...
    huggingface_models_url = entry.loc[HUGGINGFACE_MODELS_COLUMN_NAME]
    ...
    huggingface_model_badge = HUGGINGFACE_MODELS_BADGE_PATTERN.format(huggingface_models_url) if huggingface_models_url else ""
    badges = " ".join([arxiv_badge, code_badge, youtube_badge, huggingface_badge, huggingface_model_badge, colab_badge])
    return f"""
### {title}
{badges}
